...
<body>
                            ...
                            <div class="main-menu  d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a href="{{url('/')}}">Paket Cabin</a></li>
                                        <li><a href="{{url('/')}}">Tentang Kami</a></li>
                                        <li><a href="{{url('/')}}">Kontak</a></li>
                                        <li><a class="active" href="{{url('home/tiket')}}">Media Campaign</a> </li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-5 col-lg-4 d-none d-lg-block">
                            <div class="book_room">
                                ...
                                <div class="book_btn d-none d-lg-block">
                                    <a class="popup-with-form" href="https://wa.me/6282113326780?text=Halo%20Saya%20ingin%20booking%20Rumah%20Nenek%20Tepi%20Lembah%20Situ%20Gunung%20Sukabumi">Pesan Sekarang</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
    ...
    <section id="room">
        <div class="tiket_area">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="section_title text-center mb-100">
                            <h3>Paket Harga Rumah Nenek (RN) Tepi Lembah</h3>
                        </div>
                    </div>
                </div>
                <div>
                <div class="row">
                    <a href="{{asset('img/poster/cover.png')}}" data-toggle="lightbox" data-gallery="example-gallery" class="col-sm-3">
                        <img src="{{asset('img/poster/cover.png')}}" class="img-fluid" style="border: 3px solid #BABABA">
                    </a>
                    <a href="{{asset('img/poster/1.png')}}" data-toggle="lightbox" data-gallery="example-gallery" class="col-sm-3">
                        <img src="{{asset('img/poster/1.png')}}" class="img-fluid" style="border: 3px solid #BABABA">
                    </a>
                    <a href="{{asset('img/poster/2.png')}}" data-toggle="lightbox" data-gallery="example-gallery" class="col-sm-3">
                        <img src="{{asset('img/poster/2.png')}}" class="img-fluid" style="border: 3px solid #BABABA">
                    </a>
                    <a href="{{asset('img/poster/3.png')}}" data-toggle="lightbox" data-gallery="example-gallery" class="col-sm-3">
                        <img src="{{asset('img/poster/3.png')}}" class="img-fluid" style="border: 3px solid #BABABA">
                    </a>
                </div>                
                <div class="row">                    
                    <a href="{{asset('img/poster/4.png')}}" data-toggle="lightbox" data-gallery="example-gallery" class="col-sm-3">
                        <img src="{{asset('img/poster/4.png')}}" class="img-fluid" style="border: 3px solid #BABABA">
                    </a>
                    <a href="{{asset('img/poster/5.png')}}" data-toggle="lightbox" data-gallery="example-gallery" class="col-sm-3">
                        <img src="{{asset('img/poster/5.png')}}" class="img-fluid" style="border: 3px solid #BABABA">
                    </a>  
                    <a href="{{asset('img/poster/6.png')}}" data-toggle="lightbox" data-gallery="example-gallery" class="col-sm-3">
                        <img src="{{asset('img/poster/6.png')}}" class="img-fluid" style="border: 3px solid #BABABA">
                    </a>           
                    <a href="{{asset('img/poster/7.png')}}" data-toggle="lightbox" data-gallery="example-gallery" class="col-sm-3">
                        <img src="{{asset('img/poster/7.png')}}" class="img-fluid" style="border: 3px solid #BABABA">
                    </a>   
                </div>
                <div class="row">
                    <a href="{{asset('img/poster/8.png')}}" data-toggle="lightbox" data-gallery="example-gallery" class="col-sm-3">
                        <img src="{{asset('img/poster/8.png')}}" class="img-fluid" style="border: 3px solid #BABABA">
                    </a>
                    <a href="{{asset('img/poster/menu.jpg')}}" data-toggle="lightbox" data-gallery="example-gallery" class="col-sm-3">
                        <img src="{{asset('img/poster/menu.jpg')}}" class="img-fluid" style="border: 3px solid #BABABA">
                    </a>
                </div>
            </div>
        </div>
                            ...
                            <div class="row align-items-center justify-content-center">
                                <div class="col-xl-6 col-md-6">
                                    <div class="Query_text">
                                        <p>Untuk Reservasi atau Pertanyaan?</p>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-md-6">
                                    <div class="phone_num">
                                        <a href="https://wa.me/6282113326780?text=Halo%20Saya%20ingin%20booking%20Rumah%20Nenek%20Tepi%20Lembah%20Situ%20Gunung%20Sukabumi" class="mobile_no">+62 821-1332-6780</a>
                                    </div>
                                </div>
                            </div>
                        </div>
